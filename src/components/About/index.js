...
import TickerWrapperIMG from '../Assests/tickerImage'

const About = () => {
  return (
    <>
    <div className='relative bg-white text-black '>
        <div  className='flex justify-center text-4xl p-2 bg-[#fef08a]' >𝑨𝒃𝒐𝒖𝒕 𝑼𝒔</div>
        <div className='flex justify-center flex-wrap shadow-xl   p-6  text-bold bg-[#fef08a] text-black'
    //     style={{ 
