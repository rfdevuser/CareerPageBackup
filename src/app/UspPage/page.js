...
const Card1 = ({ title, description ,index}) => {
  let bgColorClass = index % 2 === 0 ? 'bg-yellow-200' : 'bg-yellow-200';
    return (
        ...
        <div className='md:w-2/3 md:pl-8 md:mx-3 flex justify-center items-center text-center'>
          <div className='mt-5 md:mt-10 text-3xl m-6 p-6'>
            ...
            <div className='flex flex-wrap justify-center mt-4'>
              <span className='border-2 border-[#be185d] rounded-lg text-lg p-2 m-2 bg-[#be185d] shadow-xl'>Collections and Designs</span>
              <span className='border-2 border-[#be185d] rounded-lg text-lg p-2 m-2 bg-[#be185d] shadow-xl'>Fashion Shows and Events</span>
              <span className='border-2 border-[#be185d] rounded-lg text-lg p-2 m-2 bg-[#be185d] shadow-xl'>Innovations and Technology</span>
              <span className='border-2 border-[#be185d] rounded-lg text-lg p-2 m-2 bg-[#be185d] shadow-xl'>Social and Environmental Impact</span>
              <span className='border-2 border-[#be185d] rounded-lg text-lg p-2 m-2 bg-[#be185d] shadow-xl'>Educational Initiatives</span>
              <span className='border-2 border-[#be185d] rounded-lg text-lg p-2 m-2 bg-[#be185d] shadow-xl'>Global Reach and Retail Presence</span>
              <span className='border-2 border-[#be185d] rounded-lg text-lg p-2 m-2 bg-[#be185d] shadow-xl'>Client Projects</span>
            </div>
          </div>
        </div>
      </div>
...
<div className='flex flex-col lg:flex-row sm:flex-col md:flex-col'>
  <div className='mt-2 mb-2 p-2 items-center lg:w-1/2 sm:w-full md:w-full mx-2 bg-[#fef08a] text-2xl text-[#500724] rounded-3xl'>
